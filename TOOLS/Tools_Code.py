##SMOLAGENTS LIBARY (Extract Audio From Video)###
...
##SMOLAGENTS LIBARY (Fetch_top_trending_youtube_videos)###
@tool
...
##SMOLAGENTS LIBARY (Log_Agent_Progress) ---> "The agent logs it's progress and updates a tkinter ScrolledText chat"#####
@tool
